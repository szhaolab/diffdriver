		...
		for i1 in ['0','1']:
			for i2 in ['0','1.2']:
				for i3 in ['200','400','600','800','1000','1200']:
					...
					#RFile.write('hmm[9]=0\n')
					RFile.write('Nsim=50\n')                			
					RFile.write('simures=power_compare(binary=TRUE,Nite=Nsim,sgdata=sgdata,bmrpars=log(BMR),Nsample=i3,betaf0=i1,beta_gc=c(i2,Fe),para=c(0.8,0.2),hotseq=hotseq0,hmm=hmm)\n')
					...
					shFile.write('#SBATCH --ntasks-per-node=4\n')
