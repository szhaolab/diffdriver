		...
		for i1 in ['0','1','1.5']:
			for i2 in ['0','0.5','1']:
				for i3 in ['200','400','600','800','1000','1200','1500','2000','2500','3000']:
					...
					RFile.write('simuresother=power_compareother(binary=TRUE,Nite=Nsim,sgdata=sgdata,bmrpars=log(BMR),Nsample=i3,betaf0=i1,beta_gc=c(i2,2.2),para=c(0.8,0.2),hotseq=hotseq2,hmm=hmm)\n')
