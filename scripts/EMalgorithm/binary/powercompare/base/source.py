		...
		for i1 in ['0','1']:
			for i2 in ['0','1.2']:
				for i3 in ['200','400','600','800','1000','1200']:
					...
					RFile.write('simuresbase=power_comparebase(binary=TRUE,Nite=Nsim,sgdata=sgdata,bmrpars=log(BMR),Nsample=i3,betaf0=i1,beta_gc=c(i2,Fe),para=c(0.8,0.2),hotseq=hotseq0,hmm=hmm)\n')
