...
```{r}
res <- diffdriver(genef, mutf, phenof, bmrf, j = 2, hotf, annodir = "~/temp/annodir96", k=6, BMRmode = "signature", outputdir = outputdir, outputname = outputname)
res
```
...
```{r}
res <- diffdriver(genef, mutf, phenof, bmrf, j = 2, hotf, annodir = "~/temp/annodir9", BMRmode = "regular", outputdir = outputdir, outputname = outputname)
res
```
